...
import {
    ...
    HiChevronDoubleLeft, HiChevronDoubleRight, HiSun, HiMoon, HiBell
...
const DashboardLayout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen flex bg-dark-50 dark:bg-dark-950 transition-colors duration-500">
            {/* Sidebar */}
            <motion.aside
            ...
            >
                ...
                {/* Collapse */}
                <div className="p-2 border-t border-dark-200 dark:border-dark-800">
                    <button
            ...
            <div className="flex-1 flex flex-col transition-all duration-300" style={{ marginLeft: collapsed ? 72 : 260 }}>
                {/* Top Nav */}
                <header className="sticky top-0 z-30 h-16 flex items-center justify-between px-6 border-b border-dark-200 dark:border-dark-800 bg-white/80 dark:bg-dark-900/80 backdrop-blur-xl">
                    <div>
